...
const Homepage = () => {
  ...
  const projects = [
    ...
    {
      name: "/project6.png",
      title: "BrewTopia - Coffee Ecommerce",
      description:
        "Full-stack specialty coffee platform with AI recommendations, Stripe payments, and automated notifications",
      tech: [
        "React Router v7",
        "TypeScript",
        "Supabase",
      ...
      url: "https://coffee-khaki-seven.vercel.app",
    },
  ];
  ...
  const frontendTech = [
    ...
    { icon: <SiTailwindcss size={24} />, name: "Tailwind CSS" },
    { icon: <SiFramer size={24} />, name: "Framer Motion" },
    { icon: <SiSwiper size={24} />, name: "Swiper.js" },
    { icon: <SiMui size={24} />, name: "Material UI" },
    { icon: <FaQrcode size={24} />, name: "QR Code Generation" },
    { icon: <FaRobot size={24} />, name: "AI Integration" },
  ];

  const backendTech = [
    { icon: <FaNodeJs size={24} />, name: "Node.js" },
    { icon: <SiNodedotjs size={24} />, name: "Nodemailer" },
    { icon: <SiExpress size={24} />, name: "Express.js" },
    { icon: <SiSupabase size={24} />, name: "Supabase" },
    { icon: <FaDatabase size={24} />, name: "PostgreSQL" },
    { icon: <SiPrisma size={24} />, name: "Prisma" },
    { icon: <SiJsonwebtokens size={24} />, name: "JWT" },
    { icon: <SiStripe size={24} />, name: "Stripe API" },
    { icon: <SiTwilio size={24} />, name: "Twilio" },
    { icon: <FaMobileAlt size={24} />, name: "CallMeBot" },
  ];

  const integrationsTech = [
    { icon: <SiOpenai size={24} />, name: "DeepSeek AI" },
    { icon: <SiOpenai size={24} />, name: "OpenAI API" },
    { icon: <FaRobot size={24} />, name: "AI Chatbots" },
    { icon: <FaDatabase size={24} />, name: "NewsData.io" },
    { icon: <SiMailchimp size={24} />, name: "Mailchimp" },
    { icon: <SiMinutemailer size={24} />, name: "EmailJS" },
    { icon: <FaEnvelope size={24} />, name: "PDFKit" },
    { icon: <FaCloudUploadAlt size={24} />, name: "Vercel" },
    { icon: <FaShieldAlt size={24} />, name: "Prompt Engineering" },
    { icon: <GiAmericanFootballHelmet size={24} />, name: "React Helmet" },
    { icon: <SiVitest size={24} />, name: "Vitest" },
    { icon: <SiFirebase size={24} />, name: "Firebase Auth" },
    { icon: <IoShield size={24} />, name: "NextAuth.js" },
    ...
    <>
      <div id="ss" className="homeDiv">
        ...
        >
          ...
          <motion.div variants={item} className="flex gap-6">
            <Link
              href="https://github.com/youcef23061983"
              target="_blank"
              className="p-3 bg-gray-800 text-white rounded-full hover:bg-gray-700 transition"
              data-tooltip-id="github-tooltip"
              data-tooltip-content="My GitHub"
        ...
        <div className="container mx-auto px-6">
          ...
          <div>
            ...
            <motion.div
              ...
              className="flex flex-wrap justify-center gap-6"
            >
              {integrationsTech.map((tech, index) => (
                <motion.div
                  key={index}
                  variants={bounce}
                  className="p-6 bg-gray-50 rounded-xl shadow-md hover:shadow-lg transition cursor-pointer flex flex-col items-center group"
                  title={tech.name}
                >
                  <div className="w-12 h-12 flex items-center justify-center text-2xl group-hover:text-green-600 transition-colors">
                    {tech.icon}
                  </div>
                  <span className="mt-2 text-sm font-medium text-gray-500 group-hover:text-gray-700">
                    {tech.name}
      ...
      <section id="bb" className="m-4 py-20">
        ...
        {/* <div className="mb-12">
          <motion.div
            ...
            viewport={{ once: true }}
            custom={0}
            className="relative overflow-hidden rounded-2xl shadow-2xl hover:shadow-3xl transition group"
          >
            <Link href="https://brewtopia.vercel.app" target="_blank">
              {/* Featured badge */}
        {/* <div className="absolute top-4 left-4 z-10 px-4 py-2 bg-amber-600 text-white rounded-full text-sm font-bold">
                FEATURED PROJECT
              </div>

              <div className="aspect-w-16 aspect-h-9">
                <div className="w-full h-64 bg-gradient-to-r from-amber-500 to-brown-700 flex items-center justify-center">
                  <div className="text-center text-white">
                    <h3 className="text-3xl font-bold mb-2">BrewTopia</h3>
                    <p className="text-lg">Coffee Ecommerce Platform</p>
                  </div>
                </div>
              </div>
              <div className="bg-gradient-to-b from-gray-900 to-gray-800 p-8">
                <h3 className="text-white text-2xl font-bold mb-3">
                  BrewTopia - Full-Stack Coffee Ecommerce
                </h3>
                <p className="text-gray-300 mb-6">
                  Specialty coffee platform featuring AI-powered recommendations
                  (DeepSeek), Stripe payments with automated receipts (PDFKit),
                  Supabase PostgreSQL for users/products/orders, NewsData.io
                  articles, WhatsApp SMS via CallMeBot, and integrated marketing
                  tools.
                </p>
                <div className="flex flex-wrap gap-2">
                  {projects[0].tech.map((tech, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 bg-amber-600/80 text-white text-sm rounded-full"
                    >
                      {tech}
                    </span>
                  ))}
